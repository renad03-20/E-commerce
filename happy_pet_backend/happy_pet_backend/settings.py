"""
Django settings for happy_pet_backend project.
...
SECRET_KEY = 'django-insecure-i*$(d^3quejjbgb2vll(yx4q*a3m(t4*brf&=s2$iswtdz2azm'
...
WSGI_APPLICATION = 'happy_pet_backend.wsgi.application'
